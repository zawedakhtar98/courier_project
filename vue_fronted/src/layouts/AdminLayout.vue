...
<template>
  <div class="admin-wrapper">
    ...
    >
      ...
      <AdminHeader
        @toggle-mobile-sidebar="handleToggleMobileSidebar"
        @open-new-shipment="handleOpenNewShipment"
      />
            ...
            <div class="modal-body p-4">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input
                    v-model="newShipment.destinationCity"
                    type="text"
                    class="form-control"
                ...
                <div class="col-md-4">
                  ...
                  <input
                    v-model="newShipment.packageWeight"
                    type="number"
                    step="0.1"
                    class="form-control"
                    required
